...
let personName: string = "farrukh";
console.log(`Hellow ${personName}, do you want to eat sweet?`);

// Question 3:

//Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
let personNAme: string = "Atif aslam";
console.log(personNAme.toLowerCase());
console.log(personNAme.toUpperCase());
console.log(personNAme.replace(/\b\w/g, (c: string) => c.toUpperCase()));
...
/*Names: Store the names of a few of your friends in a array called names.
 ...
 let names :string[] = ["farrukh", "shan","ali"];
...
let names2 :string[] = ["farrukh", "shan","ali"];
...
let favtransp:string [] = ["honda70" , "honda125" , "YR"];
...
let Guest:string[]=["shan", "ali","ahmed"];
...
let visitPlaces : string[] = ["islamabad","lahore","karachi","peshawar"];
